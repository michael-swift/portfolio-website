...
I wanted to explore the Dalle api along with some combinatorial programming and plots to create a semi-random collage of edits to American Gothic. I also used GPT to make the art style prompts and utilized ChatGPT for help with the matplotlib which is kind of recursive.
<!--more-->
...
### Use GPT to Get Art Styles


```python
# Ask GPT for art styles
